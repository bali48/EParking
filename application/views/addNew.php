                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required digits" id="mobile" name="mobile" maxlength="11">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3 hidediv" style="display: none;">
                                    <div class="form-group">
                                        <label for="comp">For Company</label>
                                        <select class="form-control required" id="comp" name="comp">
